...
extension Color {
    ...
    static let myColor: Color = Color(UIColor(red: 1.0, green: 0.949, blue: 0.9373, alpha: 1.0))
...
struct ThreadsViewModel: View {
    ...
    @State var Threads: [Thread] = [Thread(content: "I'm cooked with mr kittikawin", comment: "I guess you are right!"),
                            ...
                            VStack {
                                ...
                                ZStack{
                                    Rectangle()
                                        ...
                                        .padding(.top, 20)
                                    VStack{
                                        Text("Hello i am one of member from PS_Techno team!")
